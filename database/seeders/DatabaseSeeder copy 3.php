...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Create volunteer profile with ALL columns after migration
        Volunteer::create([
        ...
        // Livestock for Farmer 1 - UPDATED: Include user_id
        $cattle1 = Livestock::create([
            'user_id' => $farmer1->id,      // ADDED: user_id same as owner_id
            'owner_id' => $farmer1->id,
            'type' => 'cattle',
            'breed' => 'Holstein',
            'tag_number' => 'COW-001',
        ...
        $goat1 = Livestock::create([
            'user_id' => $farmer2->id,      // ADDED: user_id same as owner_id
            'owner_id' => $farmer2->id,
            'type' => 'goat',
            'breed' => 'Boer',
            'tag_number' => 'GOAT-001',
        ...
        $poultry1 = Livestock::create([
            'user_id' => $farmer3->id,      // ADDED: user_id same as owner_id
            'owner_id' => $farmer3->id,
            'type' => 'poultry',
        ...
        VaccinationHistory::create([
            'livestock_id' => $cattle1->id,
            'vaccine_name' => 'FMD Vaccine',
            'vaccine_type' => 'Foot and Mouth Disease',
            'vaccination_date' => now()->subMonths(3),
            'next_vaccination_date' => now()->addMonths(3),
            'administered_by' => $professional1->name,
            'batch_number' => 'FMD-2024-001',
            'notes' => 'Annual FMD vaccination',
        ]);
        
        VaccinationHistory::create([
            'livestock_id' => $goat1->id,
            'vaccine_name' => 'PPR Vaccine',
            'vaccine_type' => 'Peste des Petits Ruminants',
            'vaccination_date' => now()->subMonths(2),
            'next_vaccination_date' => now()->addMonths(10),
            'administered_by' => $professional1->name,
            'batch_number' => 'PPR-2024-010',
            'notes' => 'PPR protection',
        ]);
        
        $this->command->info('✅ Vaccination records created (2 records)');
        ...
        $this->command->info('Total Vaccinations: ' . VaccinationHistory::count());
