...
class FarmRecordController extends Controller
{
    ...
    public function submit(Request $request)
    {
        ...
        if ($farmRecordId) {
            ...
            if ($farmRecord) {
                ...
                $farmRecord->update(['status' => 'submitted']);
            }
        } else {
        ...
        if (auth()->user()->dataCollectorProfile) {
            $profile = auth()->user()->dataCollectorProfile;
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('data-collector.farm-records.drafts')
