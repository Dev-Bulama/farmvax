...
class FarmRecordController extends Controller
{
    ...
    public function saveStep(Request $request, $step)
    {
        ...
        // If last step, redirect to review/submit
    ...
    public function submit(Request $request)
    {
        ...
        // Update data collector profile stats
        if (auth()->user()->dataCollectorProfile) {
            auth()->user()->dataCollectorProfile->incrementSubmissions(false);
        }
...
private function loadRecordIntoSteps(FarmRecord $record)
{
    return [
        'step1' => [
            ...
            'city' => $record->farmer_city,  // Map farmer_city to city
            'state' => $record->farmer_state,  // Map farmer_state to state
            'lga' => $record->farmer_lga,  // Map farmer_lga to lga
        ...
        'step2' => [
            ...
            'livestock_types' => $record->livestock_types,
        ...
        'step3' => [
            ...
            'current_health_issues' => $record->current_health_issues,
            ...
            'past_diseases' => $record->past_diseases,
        ],
        'step4' => [
            'service_needs' => $record->service_needs,
