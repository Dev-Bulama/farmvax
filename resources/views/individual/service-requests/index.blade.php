...
<div class="flex h-screen overflow-hidden">
    ...
    <aside id="sidebar" class="fixed md:static inset-y-0 left-0 transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out z-50 md:z-auto w-64 bg-primary flex flex-col">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('individual.service-requests.index') }}" class="flex items-center px-3 py-3 text-sm font-semibold text-white bg-white/20 rounded-lg border-l-4 border-white">
                <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 hidden sm:block">Request and track veterinary services</p>
                        </div>
                    </div>
                    <a href="{{ route('individual.service-requests.create') }}" class="hidden sm:flex items-center px-4 py-2 bg-primary text-white font-bold rounded-xl hover:bg-primary/90 transition">
        ...
        <main class="flex-1 overflow-y-auto px-4 sm:px-6 lg:px-8 py-8 bg-gray-50">
            ...
            <div class="sm:hidden mb-6">
                <a href="{{ route('individual.service-requests.create') }}" class="flex items-center justify-center w-full px-4 py-3 bg-primary text-white font-bold rounded-xl hover:bg-primary/90 transition">
                    <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                    </svg>
                    New Service Request
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        <p class="text-sm text-gray-900 line-clamp-2">{{ Str::limit($request->description ?? 'No description', 60) }}</p>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @php
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        <a href="{{ route('individual.service-requests.show', $request->id) }}" class="text-primary font-semibold hover:text-primary/80">View →</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                        ...
                        <div class="bg-gray-50 rounded-xl p-4">
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-gray-900 mt-2 line-clamp-2">{{ Str::limit($request->description ?? 'No description', 80) }}</p>
                                </div>
                            </div>
                            <div class="flex items-center justify-between mt-3 pt-3 border-t border-gray-200">
                                ...
                                <a href="{{ route('individual.service-requests.show', $request->id) }}" class="text-primary font-semibold text-sm hover:text-primary/80">View →</a>
                            </div>
                ...
                @else
                    <div class="text-center py-16">
                        ...
                        <h3 class="mt-2 text-sm font-bold text-gray-900">No service requests</h3>
                        <p class="mt-1 text-sm text-gray-500">Get started by requesting veterinary services for your livestock.</p>
                        <div class="mt-6">
