...
<div class="flex h-screen overflow-hidden">
    ...
    <aside id="sidebar" class="fixed md:static inset-y-0 left-0 transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out z-50 md:z-auto w-64 bg-primary flex flex-col">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('professional.farm-records') }}" class="flex items-center px-3 py-3 text-sm font-medium text-gray-200 hover:bg-white/10 rounded-lg transition">
                <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                Farm Records
            </a>
            <a href="{{ route('professional.service-requests') }}" class="flex items-center px-3 py-3 text-sm font-semibold text-white bg-secondary/20 rounded-lg border-l-4 border-secondary">
                <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div class="hidden md:block overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-primary text-white">
                                <tr>
                                    <th class="px-6 py-3 text-left text-xs font-bold uppercase">Farmer</th>
                                    <th class="px-6 py-3 text-left text-xs font-bold uppercase">Service Type</th>
                                    <th class="px-6 py-3 text-left text-xs font-bold uppercase">Description</th>
                                    <th class="px-6 py-3 text-left text-xs font-bold uppercase">Urgency</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @php
                                            ...
                                            $statusColors = [
                                                ...
                                                'completed' => 'bg-secondary/10 text-secondary font-black',
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        <a href="{{ route('professional.service-requests.show', $request->id) }}" class="text-primary font-bold hover:text-secondary transition">View →</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                    ...
                    <div class="md:hidden p-4 space-y-4">
                        ...
                        <div class="bg-gray-50 rounded-xl p-4 border-l-4 border-primary">
                            ...
                            <div class="flex items-center justify-between pt-3 border-t border-gray-200">
                                ...
                                <a href="{{ route('professional.service-requests.show', $request->id) }}" class="text-primary font-bold text-sm hover:text-secondary transition">View →</a>
                            </div>
                        </div>
                        @endforeach
                    </div>
                ...
                @else
                    <div class="text-center py-16">
                        ...
                        <h3 class="text-lg font-black text-primary">No service requests available</h3>
