            ...
            <div class="flex flex-col w-64 bg-blue-800">
                ...
                <nav class="flex-1 overflow-y-auto">
                    <div class="px-2 py-4 space-y-1">
                        <a href="{{ route('data-collector.dashboard') }}" class="text-blue-100 hover:bg-blue-700 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                        ...
                        <a href="{{ route('data-collector.farm-records.index') }}" class="bg-blue-900 text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                            <svg class="mr-3 h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-900">
                                    {{ $record->farmer_city }}, {{ $record->state }}
                                </td>
                                <td class="px-6 py-4 text-sm text-gray-900">
