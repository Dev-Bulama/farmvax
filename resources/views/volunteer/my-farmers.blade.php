...
<head>
    ...
    <title>My Farmers - FarmVax</title>
        ...
        <aside class="hidden md:flex md:flex-shrink-0">
            <div class="flex flex-col w-64 bg-brand-green">
                ...
                <nav class="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
                    ...
                    <a href="{{ route('volunteer.my-farmers') }}" class="flex items-center px-2 py-2 text-sm font-medium text-white bg-green-600 rounded-md">
                        <svg class="mr-3 h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <header class="bg-white shadow">
                <div class="px-4 sm:px-6 lg:px-8 py-4">
                    <div class="flex justify-between items-center">
                        <div>
                            <h1 class="text-2xl font-bold brand-teal">My Farmers</h1>
                            <p class="text-sm text-gray-600">Farmers you've enrolled to the platform</p>
                        </div>
                        <a href="{{ route('volunteer.enroll.farmer') }}" class="bg-brand-green text-white px-4 py-2 rounded-lg text-sm font-medium hover:opacity-90 transition">
                            + Enroll New Farmer
                        </a>
                    </div>
                </div>
            ...
            <main class="px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="bg-white rounded-lg shadow p-6 mb-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-600">Total Farmers Enrolled</p>
                            <p class="text-3xl font-bold brand-teal">{{ $farmers->total() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow">
                    <div class="px-6 py-4 border-b border-gray-200">
                        <h2 class="text-lg font-bold brand-teal">Enrolled Farmers</h2>
                    </div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                <div class="h-10 w-10 rounded-full bg-brand-green flex items-center justify-center text-white font-bold">
                                                    {{ substr($enrollment->farmer->name, 0, 1) }}
                                                </div>
                                            </div>
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-gray-900">
                                                    {{ $enrollment->farmer->name }}
                                                </div>
                                                <div class="text-sm text-gray-500">
                                                    {{ $enrollment->farmer->email }}
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $enrollment->farmer->phone }}</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900">{{ $enrollment->location }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <div class="p-12 text-center">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Get started by enrolling your first farmer to the platform.</p>
                        <div class="mt-6">
